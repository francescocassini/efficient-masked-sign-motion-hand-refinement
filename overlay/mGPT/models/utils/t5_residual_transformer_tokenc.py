"""T5-1C residual predictor conditioned on P5 features and base tokens."""
...
class T5ResidualTokenConditionedTransformer(nn.Module):
    def __init__(
        self,
        ...
        self.input_projection = nn.Linear(base_features + token_dim * 3, hidden_features)
