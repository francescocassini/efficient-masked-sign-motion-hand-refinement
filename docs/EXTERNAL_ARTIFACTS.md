...
public delta repository. Paths are relative to the reconstructed SOKE checkout
after running `scripts/apply_delta.sh`.
...
Then run from the reconstructed SOKE root:
